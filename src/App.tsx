...
import { Armchair, Laptop, Calendar, Users, Clock, MapPin, GraduationCap, ChevronRight } from 'lucide-react';
...
function App() {
  ...
  const renderColumn = (seats: Array<{ id: string; isBooked: boolean }>, label: string) => (
                  ...
                  <div className="w-full"> {/* Full width container */}
                    ...
                    <div className="flex flex-col items-center mb-4 sm:mb-12">
                      ...
                      <div className="w-2/3 h-2 sm:h-4 bg-gray-200 rounded-lg mb-4 sm:mb-12">
                        <div className="text-center text-[10px] sm:text-sm text-gray-500 mt-2 sm:mt-6">Instructor Area</div>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between gap-1 sm:gap-8 mb-4 sm:mb-12">
                      ...
                      <div className="w-4 sm:w-16 flex items-center justify-center">
                        <div className="text-gray-400 text-[8px] sm:text-sm rotate-90">Walking Space</div>
                      </div>
